        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400">
                    {{ isset($pelanggan) ? $pelanggan->nomor_pelanggan : 'Isi form berikut dengan lengkap' }}</p>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="id_pelanggan" name="id_pelanggan"
                                ...
                                class="form-input font-mono @error('id_pelanggan') border-red-400 @enderror"
                                maxlength="20">
                        ...
                        <div>
                            ...
                            <input type="text" id="dusun" name="dusun"
                                value="{{ old('dusun', $pelanggan->dusun ?? '') }}"
                                class="form-input @error('dusun') border-red-400 @enderror" placeholder="Nama dusun">
                        ...
                        @if(!isset($pelanggan))
                            <div class="sm:col-span-2">
                                <div class="p-4 bg-blue-50 border border-blue-200 rounded-xl mb-1">
                                    ...
                                    <p class="text-xs text-blue-600">Pelanggan akan menggunakan email dan password ini untuk
                                        login dan membayar tagihan di portal.</p>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="form-input" placeholder="Ulangi password" required minlength="8"
